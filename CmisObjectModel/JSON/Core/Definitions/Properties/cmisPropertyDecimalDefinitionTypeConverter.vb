...
Namespace CmisObjectModel.Core.Definitions.Properties
   <Attributes.JavaScriptConverter(GetType(JSON.Core.Definitions.Properties.cmisPropertyDecimalDefinitionTypeConverter))>
   Partial Class cmisPropertyDecimalDefinitionType
   End Class
End Namespace

Namespace CmisObjectModel.JSON.Core.Definitions.Properties
   <Attributes.AutoGenerated()>
   Partial Public Class cmisPropertyDecimalDefinitionTypeConverter
      Inherits Generic.cmisPropertyDefinitionTypeConverter(Of Decimal, CmisObjectModel.Core.Choices.cmisChoiceDecimal, 
                                                              CmisObjectModel.Core.Properties.cmisPropertyDecimal, 
                                                              ccdp.cmisPropertyDecimalDefinitionType)

#Region "Constructors"
      Public Sub New()
         MyBase.New(New JSON.Serialization.Generic.DefaultObjectResolver(Of ccdp.cmisPropertyDefinitionType, ccdp.cmisPropertyDecimalDefinitionType))
      End Sub
