...
Namespace CmisObjectModel.Core.Definitions.Properties
   <Attributes.JavaScriptConverter(GetType(JSON.Core.Definitions.Properties.cmisPropertyIntegerDefinitionTypeConverter))>
   Partial Class cmisPropertyIntegerDefinitionType
   End Class
End Namespace

Namespace CmisObjectModel.JSON.Core.Definitions.Properties
   <Attributes.AutoGenerated()>
   Partial Public Class cmisPropertyIntegerDefinitionTypeConverter
      Inherits Generic.cmisPropertyDefinitionTypeConverter(Of xs_Integer, CmisObjectModel.Core.Choices.cmisChoiceInteger, 
                                                              CmisObjectModel.Core.Properties.cmisPropertyInteger, 
                                                              ccdp.cmisPropertyIntegerDefinitionType)

#Region "Constructors"
      Public Sub New()
         MyBase.New(New JSON.Serialization.Generic.DefaultObjectResolver(Of ccdp.cmisPropertyDefinitionType, ccdp.cmisPropertyIntegerDefinitionType))
      End Sub
