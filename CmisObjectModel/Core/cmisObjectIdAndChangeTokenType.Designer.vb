...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisObjectIdAndChangeTokenType, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If Not String.IsNullOrEmpty(_newId) Then WriteElement(writer, attributeOverrides, "newId", Constants.Namespaces.cmis, _newId)
         If Not String.IsNullOrEmpty(_changeToken) Then WriteElement(writer, attributeOverrides, "changeToken", Constants.Namespaces.cmis, _changeToken)
      End Sub
#End Region
      ...
      Protected _newId As String
      Public Overridable Property NewId As String
         Get
            Return _newId
         End Get
         Set(value As String)
