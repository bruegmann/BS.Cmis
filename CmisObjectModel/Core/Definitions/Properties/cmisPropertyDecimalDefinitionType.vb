...
Namespace CmisObjectModel.Core.Definitions.Properties
   <sxs.XmlRoot(cmisPropertyDecimalDefinitionType.DefaultElementName, Namespace:=Constants.Namespaces.cmis),
    Attributes.CmisTypeInfo(cmisPropertyDecimalDefinitionType.CmisTypeName, cmisPropertyDecimalDefinitionType.TargetTypeName, cmisPropertyDecimalDefinitionType.DefaultElementName)>
   Partial Public Class cmisPropertyDecimalDefinitionType
      ...
      Public Sub New(id As String, localName As String, localNamespace As String, displayName As String, queryName As String,
                     ...
                     ParamArray choices As Core.Choices.cmisChoiceDecimal())
      ...
      Public Sub New(id As String, localName As String, localNamespace As String, displayName As String, queryName As String,
                     required As Boolean, inherited As Boolean, queryable As Boolean, orderable As Boolean,
                     cardinality As enumCardinality, updatability As enumUpdatability, defaultValue As Core.Properties.cmisPropertyDecimal,
                     ParamArray choices As Core.Choices.cmisChoiceDecimal())
         MyBase.New(id, localName, localNamespace, displayName, queryName,
...
#Region "Constants"
      Public Const CmisTypeName As String = "cmis:cmisPropertyDecimalDefinitionType"
      Public Const TargetTypeName As String = Core.Properties.cmisPropertyDecimal.CmisTypeName
      Public Const DefaultElementName As String = "propertyDecimalDefinition"
#End Region
