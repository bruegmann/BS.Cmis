...
Namespace CmisObjectModel.Core.Definitions.Types
   <Attributes.CmisTypeInfo(cmisTypePolicyDefinitionType.CMISTypeName, cmisTypePolicyDefinitionType.TargetTypeName, cmisTypePolicyDefinitionType.DefaultElementName)>
   Partial Public Class cmisTypePolicyDefinitionType
...
#Region "Constants"
      Public Shadows Const CMISTypeName As String = "cmis:cmisTypePolicyDefinitionType"
      Public Const TargetTypeName As String = "cmis:policy"
      Public Const DefaultElementName As String = "typePolicyDefinition"
#End Region

      Protected Overrides ReadOnly Property _baseId As enumBaseObjectTypeIds
         Get
            Return enumBaseObjectTypeIds.cmisPolicy
         End Get
      End Property

      ''' <summary>
      ''' Returns the defaultProperties of a TypePolicyDefinition-instance
      ''' </summary>
      ...
      Public Shared Function GetDefaultProperties(localNamespace As String, isBaseType As Boolean) As List(Of Core.Definitions.Properties.cmisPropertyDefinitionType)
         With New Common.PredefinedPropertyDefinitionFactory(localNamespace, isBaseType)
            Return New List(Of Core.Definitions.Properties.cmisPropertyDefinitionType) From {
               ...
               .LastModifiedBy, .LastModificationDate, .ChangeToken, .PolicyText}
         End With
      End Function
