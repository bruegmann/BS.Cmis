...
Namespace CmisObjectModel.Core.Definitions.Types
   <Attributes.CmisTypeInfo(cmisTypeSecondaryDefinitionType.CMISTypeName, cmisTypeSecondaryDefinitionType.TargetTypeName, cmisTypeSecondaryDefinitionType.DefaultElementName)>
   Partial Public Class cmisTypeSecondaryDefinitionType
...
#Region "Constants"
      Public Shadows Const CMISTypeName As String = "cmis:cmisTypeSecondaryDefinitionType"
      Public Const TargetTypeName As String = "cmis:secondary"
      Public Const DefaultElementName As String = "typeSecondaryDefinition"
#End Region
      ...
      Public Shared Function GetDefaultProperties(localNamespace As String, isBaseType As Boolean) As List(Of Core.Definitions.Properties.cmisPropertyDefinitionType)
         Return New List(Of Core.Definitions.Properties.cmisPropertyDefinitionType)
      End Function
