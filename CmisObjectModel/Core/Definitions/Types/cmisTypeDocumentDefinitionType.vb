...
Namespace CmisObjectModel.Core.Definitions.Types
   <Attributes.CmisTypeInfo(cmisTypeDocumentDefinitionType.CMISTypeName, cmisTypeDocumentDefinitionType.TargetTypeName, cmisTypeDocumentDefinitionType.DefaultElementName)>
   Partial Public Class cmisTypeDocumentDefinitionType
...
#Region "Constants"
      Public Shadows Const CMISTypeName As String = "cmis:cmisTypeDocumentDefinitionType"
      Public Const TargetTypeName As String = "cmis:document"
      Public Const DefaultElementName As String = "typeDocumentDefinition"
#End Region
      ...
      Public Shared Function GetDefaultProperties(localNamespace As String, isBaseType As Boolean) As List(Of Core.Definitions.Properties.cmisPropertyDefinitionType)
         With New Common.PredefinedPropertyDefinitionFactory(localNamespace, isBaseType)
            Return New List(Of Core.Definitions.Properties.cmisPropertyDefinitionType) From {
               ...
               .LastModifiedBy, .LastModificationDate, .ChangeToken, .IsImmutable, .IsLatestVersion, .IsMajorVersion, .IsLatestMajorVersion,
               .IsPrivateWorkingCopy, .VersionLabel, .VersionSeriesId, .IsVersionSeriesCheckedOut, .VersionSeriesCheckedOutBy, .VersionSeriesCheckedOutId,
