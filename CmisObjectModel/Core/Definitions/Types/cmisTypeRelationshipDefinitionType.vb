...
Namespace CmisObjectModel.Core.Definitions.Types
   <Attributes.CmisTypeInfo(cmisTypeRelationshipDefinitionType.CMISTypeName, cmisTypeRelationshipDefinitionType.TargetTypeName, cmisTypeRelationshipDefinitionType.DefaultElementName)>
   Partial Public Class cmisTypeRelationshipDefinitionType
...
#Region "Constants"
      Public Shadows Const CMISTypeName As String = "cmis:cmisTypeRelationshipDefinitionType"
      Public Const TargetTypeName As String = "cmis:relationship"
      Public Const DefaultElementName As String = "typeRelationshipDefinition"
#End Region
      ...
      Public Shared Function GetDefaultProperties(localNamespace As String, isBaseType As Boolean) As List(Of Core.Definitions.Properties.cmisPropertyDefinitionType)
         With New Common.PredefinedPropertyDefinitionFactory(localNamespace, isBaseType)
            Return New List(Of Core.Definitions.Properties.cmisPropertyDefinitionType) From {
               ...
               .LastModifiedBy, .LastModificationDate, .ChangeToken, .SourceId, .TargetId}
         End With
      End Function
