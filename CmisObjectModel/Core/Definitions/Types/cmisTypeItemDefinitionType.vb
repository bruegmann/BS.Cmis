...
Namespace CmisObjectModel.Core.Definitions.Types
   <Attributes.CmisTypeInfo(cmisTypeItemDefinitionType.CMISTypeName, cmisTypeItemDefinitionType.TargetTypeName, cmisTypeItemDefinitionType.DefaultElementName)>
   Partial Public Class cmisTypeItemDefinitionType
...
#Region "Constants"
      Public Shadows Const CMISTypeName As String = "cmis:cmisTypeItemDefinitionType"
      Public Const TargetTypeName As String = "cmis:item"
      Public Const DefaultElementName As String = "typeItemDefinition"
#End Region
      ...
      Public Shared Function GetDefaultProperties(localNamespace As String, isBaseType As Boolean) As List(Of Core.Definitions.Properties.cmisPropertyDefinitionType)
         With New Common.PredefinedPropertyDefinitionFactory(localNamespace, isBaseType)
            Return New List(Of Core.Definitions.Properties.cmisPropertyDefinitionType) From {
               ...
               .LastModifiedBy, .LastModificationDate, .ChangeToken}
         End With
      End Function
