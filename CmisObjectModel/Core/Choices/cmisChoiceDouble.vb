...
Namespace CmisObjectModel.Core.Choices
   ...
   Public Class cmisChoiceDouble
      Inherits Core.Choices.Generic.cmisChoice(Of Double, cmisChoiceDouble)
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisChoiceDouble, String)) From {
         } '_setter
