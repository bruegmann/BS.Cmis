...
Namespace CmisObjectModel.Core.Choices
   ...
   Public Class cmisChoiceInteger
      Inherits Core.Choices.Generic.cmisChoice(Of xs_Integer, cmisChoiceInteger)
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisChoiceInteger, String)) From {
         } '_setter
