...
Namespace CmisObjectModel.Core.Choices
   ...
   ''' </summary>
   ''' <remarks>
   ''' see cmisChoiceDecimal
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Core.xsd
   ''' </remarks>
   Public Class cmisChoiceDecimal
      Inherits Core.Choices.Generic.cmisChoice(Of Decimal, cmisChoiceDecimal)
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisChoiceDecimal, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _values = ReadArray(Of Decimal)(reader, attributeOverrides, "value", Constants.Namespaces.cmis)
