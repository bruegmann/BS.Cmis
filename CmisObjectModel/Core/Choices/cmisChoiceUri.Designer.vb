...
Namespace CmisObjectModel.Core.Choices
   ...
   Public Class cmisChoiceUri
      Inherits Core.Choices.Generic.cmisChoice(Of String, cmisChoiceUri)
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisChoiceUri, String)) From {
         } '_setter
