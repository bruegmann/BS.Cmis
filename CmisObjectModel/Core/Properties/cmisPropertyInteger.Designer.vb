...
Namespace CmisObjectModel.Core.Properties
   ...
   Public Class cmisPropertyInteger
      Inherits Core.Properties.Generic.cmisProperty(Of xs_Integer)
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisPropertyInteger, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _values = ReadArray(Of xs_Integer)(reader, attributeOverrides, "value", Constants.Namespaces.cmis)
      End Sub
