...
Namespace CmisObjectModel.Core.Properties
   <sxs.XmlRoot(cmisPropertyUri.DefaultElementName, Namespace:=Constants.Namespaces.cmis),
    Attributes.CmisTypeInfo(cmisPropertyUri.CmisTypeName, cmisPropertyUri.TargetTypeName, cmisPropertyUri.DefaultElementName)>
   Partial Public Class cmisPropertyUri
...
#Region "Constants"
      Public Const CmisTypeName As String = "cmis:cmisPropertyUri"
      Public Const TargetTypeName As String = "uri"
      Public Const DefaultElementName As String = "propertyUri"
#End Region
