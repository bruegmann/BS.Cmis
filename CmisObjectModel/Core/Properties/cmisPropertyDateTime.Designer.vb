...
Namespace CmisObjectModel.Core.Properties
   ...
   Public Class cmisPropertyDateTime
      Inherits Core.Properties.Generic.cmisProperty(Of DateTimeOffset)
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisPropertyDateTime, String)) From {
         } '_setter
