...
Namespace CmisObjectModel.Core.Properties
   <sxs.XmlRoot(cmisPropertyId.DefaultElementName, Namespace:=Constants.Namespaces.cmis),
    Attributes.CmisTypeInfo(cmisPropertyId.CmisTypeName, cmisPropertyId.TargetTypeName, cmisPropertyId.DefaultElementName)>
   Partial Public Class cmisPropertyId
...
#Region "Constants"
      Public Const CmisTypeName As String = "cmis:cmisPropertyId"
      Public Const TargetTypeName As String = "id"
      Public Const DefaultElementName As String = "propertyId"
#End Region
