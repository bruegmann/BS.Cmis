...
Namespace CmisObjectModel.Core.Properties
   <sxs.XmlRoot(cmisPropertyString.DefaultElementName, Namespace:=Constants.Namespaces.cmis),
    Attributes.CmisTypeInfo(cmisPropertyString.CmisTypeName, cmisPropertyString.TargetTypeName, cmisPropertyString.DefaultElementName)>
   Partial Public Class cmisPropertyString
...
#Region "Constants"
      Public Const CmisTypeName As String = "cmis:cmisPropertyString"
      Public Const TargetTypeName As String = "string"
      Public Const DefaultElementName As String = "propertyString"
#End Region
