...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisPermissionMapping, String)) From {
         } '_setter
...
#End Region
      ...
      Protected _key As Core.enumAllowableActionsKey
      Public Overridable Property Key As Core.enumAllowableActionsKey
         Get
            Return _key
         End Get
         Set(value As Core.enumAllowableActionsKey)
            If _key <> value Then
               Dim oldValue As Core.enumAllowableActionsKey = _key
               _key = value
