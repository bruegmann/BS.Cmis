...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisPermissionDefinition, String)) From {
         } '_setter
...
#End Region
      ...
      Protected _permission As String
      Public Overridable Property Permission As String
         Get
            Return _permission
         End Get
         Set(value As String)
            If _permission <> value Then
               Dim oldValue As String = _permission
               _permission = value
               OnPropertyChanged("Permission", value, oldValue)
            End If
         End Set
      End Property 'Permission
