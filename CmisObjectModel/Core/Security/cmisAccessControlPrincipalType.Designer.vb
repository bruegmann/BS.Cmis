...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisAccessControlPrincipalType, String)) From {
         } '_setter
...
#End Region
      ...
      Protected _principalId As String
      Public Overridable Property PrincipalId As String
         Get
            Return _principalId
         End Get
         Set(value As String)
            If _principalId <> value Then
               Dim oldValue As String = _principalId
               _principalId = value
               OnPropertyChanged("PrincipalId", value, oldValue)
            End If
         End Set
      End Property 'PrincipalId
