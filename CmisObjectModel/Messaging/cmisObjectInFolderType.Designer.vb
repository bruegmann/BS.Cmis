...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisObjectInFolderType, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If Not String.IsNullOrEmpty(_pathSegment) Then WriteElement(writer, attributeOverrides, "pathSegment", Constants.Namespaces.cmism, _pathSegment)
      End Sub
#End Region
      ...
      Protected _pathSegment As String
      Public Overridable Property PathSegment As String
         Get
            Return _pathSegment
         End Get
         Set(value As String)
            If _pathSegment <> value Then
               Dim oldValue As String = _pathSegment
               _pathSegment = value
