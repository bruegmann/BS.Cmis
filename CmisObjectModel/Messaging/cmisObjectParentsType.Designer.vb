...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisObjectParentsType, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         _object = Read(Of Core.cmisObjectType)(reader, attributeOverrides, "object", Constants.Namespaces.cmism, AddressOf GenericXmlSerializableFactory(Of Core.cmisObjectType))
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If Not String.IsNullOrEmpty(_relativePathSegment) Then WriteElement(writer, attributeOverrides, "relativePathSegment", Constants.Namespaces.cmism, _relativePathSegment)
      End Sub
#End Region
      ...
      Protected _relativePathSegment As String
      Public Overridable Property RelativePathSegment As String
         Get
            Return _relativePathSegment
         End Get
         Set(value As String)
            If _relativePathSegment <> value Then
               Dim oldValue As String = _relativePathSegment
