...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisRepositoryEntryType, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _repositoryName = Read(reader, attributeOverrides, "repositoryName", Constants.Namespaces.cmism, _repositoryName)
      End Sub
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         WriteElement(writer, attributeOverrides, "repositoryName", Constants.Namespaces.cmism, _repositoryName)
      End Sub
#End Region
