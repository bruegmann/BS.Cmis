...
Namespace CmisObjectModel.Messaging.Responses
   ...
   ''' </summary>
   ''' <remarks>
   ''' see createRelationshipResponse
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Messaging.xsd
   ''' </remarks>
   <System.CodeDom.Compiler.GeneratedCode("CmisXsdConverter", "1.0.0.0")>
   Partial Public Class createRelationshipResponse
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of createRelationshipResponse, String)) From {
         } '_setter
