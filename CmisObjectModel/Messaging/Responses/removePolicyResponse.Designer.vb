...
Namespace CmisObjectModel.Messaging.Responses
   ...
   ''' </summary>
   ''' <remarks>
   ''' see removePolicyResponse
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Messaging.xsd
   ''' </remarks>
   Public Class removePolicyResponse
      Inherits PolicyManipulationServiceResponse
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of removePolicyResponse, String)) From {
         } '_setter
