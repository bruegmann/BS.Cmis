...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of moveObjectResponse, String)) From {
         } '_setter
