...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of checkOutResponse, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         WriteElement(writer, attributeOverrides, "contentCopied", Constants.Namespaces.cmism, Convert(_contentCopied))
         WriteElement(writer, attributeOverrides, "extension", Constants.Namespaces.cmism, _extension)
      End Sub
#End Region

      Protected _contentCopied As Boolean
      Public Overridable Property ContentCopied As Boolean
         Get
            Return _contentCopied
         End Get
         Set(value As Boolean)
            If _contentCopied <> value Then
               Dim oldValue As Boolean = _contentCopied
               _contentCopied = value
               OnPropertyChanged("ContentCopied", value, oldValue)
            End If
         End Set
      End Property 'ContentCopied
