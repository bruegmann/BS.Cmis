...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getRenditionsResponse, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         _renditions = ReadArray(Of Core.cmisRenditionType)(reader, attributeOverrides, "renditions", Constants.Namespaces.cmism, AddressOf GenericXmlSerializableFactory(Of Core.cmisRenditionType))
      End Sub
