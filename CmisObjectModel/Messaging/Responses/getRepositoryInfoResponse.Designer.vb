...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getRepositoryInfoResponse, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         _repositoryInfo = Read(Of Core.cmisRepositoryInfoType)(reader, attributeOverrides, "repositoryInfo", Constants.Namespaces.cmism, AddressOf GenericXmlSerializableFactory(Of Core.cmisRepositoryInfoType))
      End Sub
...
#End Region
      ...
      Public Overridable Property RepositoryInfo As Core.cmisRepositoryInfoType
         Get
            Return _repositoryInfo
         End Get
         Set(value As Core.cmisRepositoryInfoType)
            If value IsNot _repositoryInfo Then
               Dim oldValue As Core.cmisRepositoryInfoType = _repositoryInfo
