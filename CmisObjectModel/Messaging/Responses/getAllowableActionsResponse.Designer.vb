...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getAllowableActionsResponse, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         _allowableActions = Read(Of Core.cmisAllowableActionsType)(reader, attributeOverrides, "allowableActions", Constants.Namespaces.cmism, AddressOf GenericXmlSerializableFactory(Of Core.cmisAllowableActionsType))
      End Sub
