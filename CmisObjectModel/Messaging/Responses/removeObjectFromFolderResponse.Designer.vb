...
Namespace CmisObjectModel.Messaging.Responses
   ...
   Partial Public Class removeObjectFromFolderResponse
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of removeObjectFromFolderResponse, String)) From {
         } '_setter
