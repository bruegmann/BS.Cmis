...
Namespace CmisObjectModel.Messaging.Responses
   ...
   ''' </summary>
   ''' <remarks>
   ''' see createDocumentFromSourceResponse
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Messaging.xsd
   ''' </remarks>
   <System.CodeDom.Compiler.GeneratedCode("CmisXsdConverter", "1.0.0.0")>
   Partial Public Class createDocumentFromSourceResponse
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of createDocumentFromSourceResponse, String)) From {
         } '_setter
