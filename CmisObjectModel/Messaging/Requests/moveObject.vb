...
Namespace CmisObjectModel.Messaging.Requests
   Partial Public Class moveObject
      ...
      Public Overrides Sub ReadQueryString(repositoryId As String)
         ...
         If requestParams IsNot Nothing Then
            ...
            _targetFolderId = Read(requestParams("targetFolderId"), _targetFolderId)
            _sourceFolderId = Read(requestParams("sourceFolderId"), _sourceFolderId)
         End If
      End Sub
