...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </remarks>
   <sxs.XmlRoot("getTypeDefinition", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getTypeDefinition, String)) From {
         } '_setter
