...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </summary>
   ''' <remarks>
   ''' see getObjectParents
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Messaging.xsd
   ''' </remarks>
   <sxs.XmlRoot("getObjectParents", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getObjectParents, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _includeRelativePathSegment = Read(reader, attributeOverrides, "includeRelativePathSegment", Constants.Namespaces.cmism, _includeRelativePathSegment)
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If _includeRelativePathSegment.HasValue Then WriteElement(writer, attributeOverrides, "includeRelativePathSegment", Constants.Namespaces.cmism, Convert(_includeRelativePathSegment))
...
#End Region
      ...
      Protected _includeRelativePathSegment As Boolean?
      Public Overridable Property IncludeRelativePathSegment As Boolean?
         Get
            Return _includeRelativePathSegment
         End Get
         Set(value As Boolean?)
            If Not _includeRelativePathSegment.Equals(value) Then
               Dim oldValue As Boolean? = _includeRelativePathSegment
               _includeRelativePathSegment = value
               OnPropertyChanged("IncludeRelativePathSegment", value, oldValue)
            End If
         End Set
      End Property 'IncludeRelativePathSegment
