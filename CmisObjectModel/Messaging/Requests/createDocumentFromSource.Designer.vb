...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of createDocumentFromSource, String)) From {
         } '_setter
...
#End Region
      ...
      Protected _sourceId As String
      Public Overridable Property SourceId As String
         Get
            Return _sourceId
         End Get
         Set(value As String)
            If _sourceId <> value Then
               Dim oldValue As String = _sourceId
               _sourceId = value
