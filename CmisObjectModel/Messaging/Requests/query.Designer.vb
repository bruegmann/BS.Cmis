...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of query, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If _searchAllVersions.HasValue Then WriteElement(writer, attributeOverrides, "searchAllVersions", Constants.Namespaces.cmism, Convert(_searchAllVersions))
