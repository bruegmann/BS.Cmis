...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </remarks>
   <sxs.XmlRoot("removePolicy", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of removePolicy, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _policyId = Read(reader, attributeOverrides, "policyId", Constants.Namespaces.cmism, _policyId)
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         WriteElement(writer, attributeOverrides, "policyId", Constants.Namespaces.cmism, _policyId)
...
#End Region
      ...
      Public Overridable Property PolicyId As String
         Get
            Return _policyId
         End Get
         Set(value As String)
            If _policyId <> value Then
               Dim oldValue As String = _policyId
               _policyId = value
               OnPropertyChanged("PolicyId", value, oldValue)
            End If
         End Set
      End Property 'PolicyId
