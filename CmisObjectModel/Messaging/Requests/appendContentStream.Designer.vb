...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of appendContentStream, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If _isLastChunk.HasValue Then WriteElement(writer, attributeOverrides, "isLastChunk", Constants.Namespaces.cmism, Convert(_isLastChunk))
...
#End Region
      ...
      Protected _isLastChunk As Boolean?
      Public Overridable Property IsLastChunk As Boolean?
         Get
            Return _isLastChunk
         End Get
         Set(value As Boolean?)
            If Not _isLastChunk.Equals(value) Then
               Dim oldValue As Boolean? = _isLastChunk
               _isLastChunk = value
               OnPropertyChanged("IsLastChunk", value, oldValue)
            End If
         End Set
      End Property 'IsLastChunk
