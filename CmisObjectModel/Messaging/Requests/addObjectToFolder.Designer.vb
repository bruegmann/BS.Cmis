...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </summary>
   ''' <remarks>
   ''' see addObjectToFolder
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Messaging.xsd
   ''' </remarks>
   <sxs.XmlRoot("addObjectToFolder", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of addObjectToFolder, String)) From {
         } '_setter
