...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getContentStream, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If Not String.IsNullOrEmpty(_streamId) Then WriteElement(writer, attributeOverrides, "streamId", Constants.Namespaces.cmism, _streamId)
         If _offset.HasValue Then WriteElement(writer, attributeOverrides, "offset", Constants.Namespaces.cmism, Convert(_offset))
...
#End Region
      ...
      Protected _offset As xs_Integer?
      Public Overridable Property Offset As xs_Integer?
         Get
            Return _offset
         End Get
         Set(value As xs_Integer?)
            If Not _offset.Equals(value) Then
               Dim oldValue As xs_Integer? = _offset
               _offset = value
