...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getContentChanges, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If Not String.IsNullOrEmpty(_changeLogToken) Then WriteElement(writer, attributeOverrides, "changeLogToken", Constants.Namespaces.cmism, _changeLogToken)
         If _includeProperties.HasValue Then WriteElement(writer, attributeOverrides, "includeProperties", Constants.Namespaces.cmism, Convert(_includeProperties))
...
#End Region
      ...
      Protected _includeProperties As Boolean?
      Public Overridable Property IncludeProperties As Boolean?
         Get
            Return _includeProperties
         End Get
         Set(value As Boolean?)
            If Not _includeProperties.Equals(value) Then
               Dim oldValue As Boolean? = _includeProperties
               _includeProperties = value
               OnPropertyChanged("IncludeProperties", value, oldValue)
            End If
         End Set
      End Property 'IncludeProperties
