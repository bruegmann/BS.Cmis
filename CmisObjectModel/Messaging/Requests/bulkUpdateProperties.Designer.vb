...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of bulkUpdateProperties, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _bulkUpdateData = Read(Of Core.cmisBulkUpdateType)(reader, attributeOverrides, "bulkUpdateData", Constants.Namespaces.cmism, AddressOf GenericXmlSerializableFactory(Of Core.cmisBulkUpdateType))
...
#End Region
      ...
      Protected _bulkUpdateData As Core.cmisBulkUpdateType
      Public Overridable Property BulkUpdateData As Core.cmisBulkUpdateType
         Get
            Return _bulkUpdateData
         End Get
         Set(value As Core.cmisBulkUpdateType)
            If value IsNot _bulkUpdateData Then
               Dim oldValue As Core.cmisBulkUpdateType = _bulkUpdateData
               _bulkUpdateData = value
               OnPropertyChanged("BulkUpdateData", value, oldValue)
            End If
         End Set
      End Property 'BulkUpdateData
