...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of applyACL, String)) From {
         } '_setter
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If _aCLPropagation.HasValue Then WriteElement(writer, attributeOverrides, "ACLPropagation", Constants.Namespaces.cmism, _aCLPropagation.Value.GetName())
         WriteElement(writer, attributeOverrides, "extension", Constants.Namespaces.cmism, _extension)
      End Sub
#End Region

      Protected _aCLPropagation As Core.enumACLPropagation?
      Public Overridable Property ACLPropagation As Core.enumACLPropagation?
         Get
            Return _aCLPropagation
         End Get
         Set(value As Core.enumACLPropagation?)
            If Not _aCLPropagation.Equals(value) Then
               Dim oldValue As Core.enumACLPropagation? = _aCLPropagation
               _aCLPropagation = value
               OnPropertyChanged("ACLPropagation", value, oldValue)
            End If
         End Set
      End Property 'ACLPropagation
