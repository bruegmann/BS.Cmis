...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </remarks>
   <sxs.XmlRoot("getACL", Namespace:=Constants.Namespaces.cmism)>
   Public Class getACL
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getACL, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _onlyBasicPermissions = Read(reader, attributeOverrides, "onlyBasicPermissions", Constants.Namespaces.cmism, _onlyBasicPermissions)
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If _onlyBasicPermissions.HasValue Then WriteElement(writer, attributeOverrides, "onlyBasicPermissions", Constants.Namespaces.cmism, Convert(_onlyBasicPermissions))
...
#End Region
      ...
      Protected _onlyBasicPermissions As Boolean?
      Public Overridable Property OnlyBasicPermissions As Boolean?
         Get
            Return _onlyBasicPermissions
         End Get
         Set(value As Boolean?)
            If Not _onlyBasicPermissions.Equals(value) Then
               Dim oldValue As Boolean? = _onlyBasicPermissions
               _onlyBasicPermissions = value
               OnPropertyChanged("OnlyBasicPermissions", value, oldValue)
            End If
         End Set
      End Property 'OnlyBasicPermissions
