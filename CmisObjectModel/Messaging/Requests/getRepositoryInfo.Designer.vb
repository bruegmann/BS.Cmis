...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </remarks>
   <sxs.XmlRoot("getRepositoryInfo", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getRepositoryInfo, String)) From {
         } '_setter
