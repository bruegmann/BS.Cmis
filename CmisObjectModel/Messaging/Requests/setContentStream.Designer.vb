...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </summary>
   ''' <remarks>
   ''' see setContentStream
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Messaging.xsd
   ''' </remarks>
   <sxs.XmlRoot("setContentStream", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of setContentStream, String)) From {
         } '_setter
      ...
      Protected Overrides Sub ReadXmlCore(reader As sx.XmlReader, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         _overwriteFlag = Read(reader, attributeOverrides, "overwriteFlag", Constants.Namespaces.cmism, _overwriteFlag)
      ...
      Protected Overrides Sub WriteXmlCore(writer As sx.XmlWriter, attributeOverrides As Serialization.XmlAttributeOverrides)
         ...
         If _overwriteFlag.HasValue Then WriteElement(writer, attributeOverrides, "overwriteFlag", Constants.Namespaces.cmism, Convert(_overwriteFlag))
...
#End Region
      ...
      Protected _overwriteFlag As Boolean?
      Public Overridable Property OverwriteFlag As Boolean?
         Get
            Return _overwriteFlag
         End Get
         Set(value As Boolean?)
            If Not _overwriteFlag.Equals(value) Then
               Dim oldValue As Boolean? = _overwriteFlag
               _overwriteFlag = value
               OnPropertyChanged("OverwriteFlag", value, oldValue)
            End If
         End Set
      End Property 'OverwriteFlag
