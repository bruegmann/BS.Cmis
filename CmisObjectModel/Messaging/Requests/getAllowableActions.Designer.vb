...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </summary>
   ''' <remarks>
   ''' see getAllowableActions
   ''' in http://docs.oasis-open.org/cmis/CMIS/v1.1/cs01/schema/CMIS-Messaging.xsd
   ''' </remarks>
   <sxs.XmlRoot("getAllowableActions", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getAllowableActions, String)) From {
         } '_setter
