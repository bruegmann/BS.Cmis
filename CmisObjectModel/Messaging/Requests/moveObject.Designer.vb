...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of moveObject, String)) From {
         } '_setter
...
#End Region
      ...
      Protected _sourceFolderId As String
      Public Overridable Property SourceFolderId As String
         Get
            Return _sourceFolderId
         End Get
         Set(value As String)
            If _sourceFolderId <> value Then
               Dim oldValue As String = _sourceFolderId
               _sourceFolderId = value
               OnPropertyChanged("SourceFolderId", value, oldValue)
            End If
         End Set
      End Property 'SourceFolderId

      Protected _targetFolderId As String
      Public Overridable Property TargetFolderId As String
         Get
            Return _targetFolderId
         End Get
         Set(value As String)
            If _targetFolderId <> value Then
               Dim oldValue As String = _targetFolderId
               _targetFolderId = value
               OnPropertyChanged("TargetFolderId", value, oldValue)
            End If
         End Set
      End Property 'TargetFolderId
