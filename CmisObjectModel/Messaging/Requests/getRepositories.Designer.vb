...
Namespace CmisObjectModel.Messaging.Requests
   ...
   ''' </remarks>
   <sxs.XmlRoot("getRepositories", Namespace:=Constants.Namespaces.cmism)>
...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of getRepositories, String)) From {
         } '_setter
