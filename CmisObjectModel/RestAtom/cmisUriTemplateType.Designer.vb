...
#Region "IXmlSerializable"
      Private Shared _setter As New Dictionary(Of String, Action(Of cmisUriTemplateType, String)) From {
         } '_setter
      ...
      Public Overridable Property Template As String
         ...
         Set(value As String)
            If _template <> value Then
               Dim oldValue As String = _template
               _template = value
